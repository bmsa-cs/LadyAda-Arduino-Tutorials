...
![](images/readonlywarn.jpg)

Not a big deal, you can save it under a new name, such as **MyBlink**

![](images/saveasmyblink.jpg)

Compile/Verify the sketch and Upload it, using your [Lesson 1](lesson1.html) techniques.

![](images/myblinkcompile.jpg)

![](images/myblinkupload.jpg)
...
> **_Highlight the text below to see the answer_The LED is blinking, but its blinking so fast that our eyes can't pick it up, so it looks like a blur. When the Arduino is waved in the air, we see streaks of light from the blinks.
